<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TrainList.aspx.cs" Inherits="RinnaiPortal.Area.Sign.Forms.TrainList" %>
				...
				<div class="row text-center">
					<div class="col-lg-3" style="float: none; display: inline-block">
						<div class="input-group">
							<asp:TextBox runat="server" ID="queryTextBox" class="form-control" placeholder="課程代號" />
			...
			<asp:GridView runat="server" CssClass="table table-striped table-bordered table-condensed" ID="TrainGridView" AutoGenerateColumns="False">
				<Columns>
					...
					<asp:TemplateField>
						...
						<ItemTemplate>
							<asp:Label runat="server" Text='<%# Eval("STARTDATE").ToDateTimeFormateString() %>' CssClass="STARTDATE"> </asp:Label>
						</ItemTemplate>
					</asp:TemplateField>
					<asp:TemplateField>
						<HeaderTemplate>
					...
					<asp:TemplateField HeaderText="明細" HeaderStyle-CssClass="text-center">
						...
						<ItemTemplate>
							<asp:HyperLink runat="server" CommandName="Detail" CssClass="btn btn-info btn-xs" Target="dialog" NavigateUrl='<%# "~/Area/Sign/Forms/TrainDetail.aspx?CLID=" + Eval("CLID") + "&SID=" + Eval("SID") %>'
