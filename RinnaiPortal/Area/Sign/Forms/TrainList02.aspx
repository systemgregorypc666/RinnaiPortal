<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TrainList02.aspx.cs" Inherits="RinnaiPortal.Area.Sign.Forms.TrainList02" %>
			...
			<asp:GridView runat="server" CssClass="table table-striped table-bordered table-condensed" ID="TrainGridView" AutoGenerateColumns="False">
				<Columns>
                    ...
                    <asp:TemplateField HeaderText="填寫" HeaderStyle-CssClass="text-center">
						...
						<ItemTemplate>
							<asp:HyperLink runat="server" CommandName="Edit" ClientIDMode="Static" ID="Edit" CssClass="btn btn-warning btn-xs" NavigateUrl='<%# "~/Area/Sign/Forms/TrainDetail02.aspx?CLID=" + Eval("CLID") + "&SID=" + Eval("SID") %>'
