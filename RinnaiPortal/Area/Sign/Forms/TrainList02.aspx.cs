...
namespace RinnaiPortal.Area.Sign.Forms
{
    ...
    /// 受訓心得報告新增
    /// </summary>
    public partial class TrainList02 : SignDataList
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Authentication.HasResource(User.Identity.Name, "TrainList02"))
            {
            ...
            if (!IsPostBack)
            {
                PageTitle.Value = "表單新增作業 > 受訓心得報告維護";
