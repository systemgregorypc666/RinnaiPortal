...
{
	public partial class ProcessWorkflowList : SignDataList
	{
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				signListParms.GridView = ProcessWorkflowGridView;
				signListParms.TotalRowsCount = totalRowsCount;
				signListParms.PaginationBar = paginationBar;
				signListParms.NoDataTip = noDataTip;

				//建構頁面
				ConstructPage(signListParms, paggerParms, RepositoryFactory.CreateProcessWorkflowRepo());
